...
var gallery = new Gallery('.photos-wrap', [ 
	...
	{ src:'../img/md06.png', name: '하프 더블 월 글라스 컵 (옐로우)', eng: 'Half Double Wall Glass (Yellow)', info1: '손으로 잡는 부분이 이중으로 되어있어서 차가운 음료를 담았을 때, 표면에 물이 손에 닿지 않아 음용시 편리한 유리컵', info2: '-  용량: 360ml', info3: '-  급격한 온도변화로 인한 파손주의', info4: '-  전자레인지, 식기세척기 사용금지'},
	{ src:'../img/md07.png', name: '하프 더블 월 글라스 컵 (그린)', eng: 'Half Double Wall Glass (Green)', info1: '손으로 잡는 부분이 이중으로 되어있어서 차가운 음료를 담았을 때, 표면에 물이 손에 닿지 않아 음용시 편리한 유리컵', info2: '-  용량: 360ml', info3: '-  급격한 온도변화로 인한 파손주의', info4: '-  전자레인지, 식기세척기 사용금지'},
 ]);